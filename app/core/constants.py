...
# ── Kardex: tipos de movimiento canónicos (única fuente de verdad) ──
# MP (insumos Cta 24): ENTRADA suma, SALIDA/AJUSTE restan según flujo.
# Taxonomía canónica espejo de app/models/inventario.py (TIPOS_KARDEX_*).
KARDEX_TIPOS_MP: tuple[str, ...] = (
    "ENTRADA_COMPRA", "ENTRADA_AJUSTE", "ENTRADA_DEVOLUCION",
    "SALIDA_CONSUMO_TALLER", "SALIDA_MERMA", "SALIDA_AJUSTE",
)
# PT (variantes): signo del movimiento por tipo.
KARDEX_TIPOS_PT: dict[str, int] = {
    "ENTRADA_PRODUCTO_TERMINADO": 1, "ENTRADA_AJUSTE": 1,
    "SALIDA_VENTA": -1, "SALIDA_MERMA": -1, "MUESTRA": -1,
}
# Egresos/consumos que aceptan referencia de pedido/ficha.
KARDEX_TIPOS_SALIDA: tuple[str, ...] = (
    "SALIDA_CONSUMO_TALLER", "SALIDA_VENTA",
)

# Etiquetas legibles para el selector de Kardex (valor = código canónico).
KARDEX_TIPOS_LABELS: dict[str, str] = {
    "ENTRADA_COMPRA": "Entrada por Orden de Compra",
    "ENTRADA_AJUSTE": "Ajuste de inventario / Saldo inicial",
    "ENTRADA_DEVOLUCION": "Devolución de insumo/prenda",
    "SALIDA_CONSUMO_TALLER": "Salida de materia prima a producción/corte",
    "SALIDA_MERMA": "Pérdida o merma de material",
    "SALIDA_VENTA": "Salida por venta directa RTW",
    "SALIDA_VENTA_RTW": "Salida por venta directa RTW",
    "SALIDA_AJUSTE": "Ajuste negativo por inventario",
    "ENTRADA_PRODUCTO_TERMINADO": "Ingreso de producto terminado",
    "MUESTRA": "Muestra / obsequio",
}
