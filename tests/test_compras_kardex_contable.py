...
def test_recepcion_parcial_total_con_cpp_y_asiento_241_611():
    ...
    assert len(k) == 1 and k[0].tipo_movimiento == "ENTRADA_COMPRA"
...
def test_facturar_provision_6021_40111_4212_y_billed():
    ...
    assert mapa["6021"] == (Decimal("847.46"), Decimal("0"))
...
def test_consumo_y_merma_con_asientos():
    ...
    assert mapa["2311"] == (Decimal("600"), Decimal("0"))
